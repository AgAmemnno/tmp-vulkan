...
{
  CameraIntrinsics *camera_intrinsics = libmv_cameraIntrinsicsCreateFromOptions(
...
{
  const CameraIntrinsics *orig_intrinsics = (const CameraIntrinsics *)libmv_intrinsics;
  ...
  switch (orig_intrinsics->GetDistortionModelType()) {
    case libmv::DISTORTION_MODEL_POLYNOMIAL: {
      ...
      new_intrinsics = LIBMV_OBJECT_NEW(PolynomialCameraIntrinsics, *polynomial_intrinsics);
      break;
    }
    case libmv::DISTORTION_MODEL_DIVISION: {
      ...
      new_intrinsics = LIBMV_OBJECT_NEW(DivisionCameraIntrinsics, *division_intrinsics);
      break;
    }
    case libmv::DISTORTION_MODEL_NUKE: {
      const NukeCameraIntrinsics *nuke_intrinsics = static_cast<const NukeCameraIntrinsics *>(
          orig_intrinsics);
      new_intrinsics = LIBMV_OBJECT_NEW(NukeCameraIntrinsics, *nuke_intrinsics);
      break;
    }
    case libmv::DISTORTION_MODEL_BROWN: {
      const BrownCameraIntrinsics *brown_intrinsics = static_cast<const BrownCameraIntrinsics *>(
          orig_intrinsics);
      new_intrinsics = LIBMV_OBJECT_NEW(BrownCameraIntrinsics, *brown_intrinsics);
      break;
    }
    default:
    ...
    libmv_CameraIntrinsics *libmv_intrinsics)
{
  ...
  switch (libmv_camera_intrinsics_options->distortion_model) {
    case LIBMV_DISTORTION_MODEL_POLYNOMIAL: {
      assert(camera_intrinsics->GetDistortionModelType() == libmv::DISTORTION_MODEL_POLYNOMIAL);

      PolynomialCameraIntrinsics *polynomial_intrinsics = (PolynomialCameraIntrinsics *)
          camera_intrinsics;
      ...
      if (polynomial_intrinsics->k1() != k1 || polynomial_intrinsics->k2() != k2 ||
    ...
    case LIBMV_DISTORTION_MODEL_DIVISION: {
      assert(camera_intrinsics->GetDistortionModelType() == libmv::DISTORTION_MODEL_DIVISION);

      DivisionCameraIntrinsics *division_intrinsics = (DivisionCameraIntrinsics *)
          camera_intrinsics;
    ...
    case LIBMV_DISTORTION_MODEL_NUKE: {
      assert(camera_intrinsics->GetDistortionModelType() == libmv::DISTORTION_MODEL_NUKE);

      NukeCameraIntrinsics *nuke_intrinsics = (NukeCameraIntrinsics *)camera_intrinsics;
    ...
    case LIBMV_DISTORTION_MODEL_BROWN: {
      assert(camera_intrinsics->GetDistortionModelType() == libmv::DISTORTION_MODEL_BROWN);

      BrownCameraIntrinsics *brown_intrinsics = (BrownCameraIntrinsics *)camera_intrinsics;
...
{
  const CameraIntrinsics *camera_intrinsics = (const CameraIntrinsics *)libmv_intrinsics;
  ...
  camera_intrinsics_options->principal_point_x = camera_intrinsics->principal_point_x();
  camera_intrinsics_options->principal_point_y = camera_intrinsics->principal_point_y();
                                          ...
                                          float *destination_image)
{
  ...
  intrinsics->UndistortBuffer(source_image, width, height, overscan, channels, destination_image);
}
...
{
  CameraIntrinsics *intrinsics = (CameraIntrinsics *)libmv_intrinsics;
  intrinsics->DistortBuffer(source_image, width, height, overscan, channels, destination_image);
}
    ...
    CameraIntrinsics *camera_intrinsics)
{
  ...
  switch (camera_intrinsics_options->distortion_model) {
    case LIBMV_DISTORTION_MODEL_POLYNOMIAL: {
      ...
      polynomial_intrinsics->SetRadialDistortion(camera_intrinsics_options->polynomial_k1,
    ...
    case LIBMV_DISTORTION_MODEL_DIVISION: {
      DivisionCameraIntrinsics *division_intrinsics = static_cast<DivisionCameraIntrinsics *>(
          camera_intrinsics);

      division_intrinsics->SetDistortion(camera_intrinsics_options->division_k1,
                                         camera_intrinsics_options->division_k2);
      break;
    }

    case LIBMV_DISTORTION_MODEL_NUKE: {
      NukeCameraIntrinsics *nuke_intrinsics = static_cast<NukeCameraIntrinsics *>(
          camera_intrinsics);
    ...
    case LIBMV_DISTORTION_MODEL_BROWN: {
      BrownCameraIntrinsics *brown_intrinsics = static_cast<BrownCameraIntrinsics *>(
          camera_intrinsics);

      brown_intrinsics->SetRadialDistortion(camera_intrinsics_options->brown_k1,
                                            camera_intrinsics_options->brown_k2,
                                            camera_intrinsics_options->brown_k3,
                                            camera_intrinsics_options->brown_k4);
      brown_intrinsics->SetTangentialDistortion(camera_intrinsics_options->brown_p1,
