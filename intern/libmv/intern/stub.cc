...
{
  memcpy(destination_image, source_image, channels * width * height * sizeof(unsigned char));
}
...
{
  memcpy(destination_image, source_image, channels * width * height * sizeof(float));
}
