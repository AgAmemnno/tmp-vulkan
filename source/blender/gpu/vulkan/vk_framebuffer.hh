...
class VKFrameBuffer : public FrameBuffer {
 ...
 public:
  ...
  VkCommandBuffer render_begin(VkCommandBuffer cmd, VkCommandBufferLevel level = VK_COMMAND_BUFFER_LEVEL_SECONDARY, VkClearValue* clearValues = nullptr,bool blit = false);
  void render_end();
