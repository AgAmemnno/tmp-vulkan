...
typedef libmv_CacheKey (*libmv_GetImageCallback)(libmv_FrameAccessorUserData *user_data,
                                                 int clip,
                                                 int frame,
...
typedef libmv_CacheKey (*libmv_GetMaskForTrackCallback)(libmv_FrameAccessorUserData *user_data,
                                                        int clip,
                                                        int frame,
                                                        int track,
                                                        const libmv_Region *region,
