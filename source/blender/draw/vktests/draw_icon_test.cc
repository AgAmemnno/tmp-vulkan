...
static void _icon_draw_texture(
    float x, float y, float w, float h, float alpha, const float rgb[3], GPUTexture *texture)
{
...
#endif
{
  ...
  GPUOffScreen *offscreen = GPU_offscreen_create(region.winx, region.winy, false, GPU_RGBA8, NULL);
